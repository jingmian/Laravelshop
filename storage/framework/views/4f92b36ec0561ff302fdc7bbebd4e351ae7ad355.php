                  ...
                  <div class="top">
                    <div class="img">
                      <a href="<?php echo e(route('products.show', ['product' => $product->id]), false); ?>">
                        <img src="<?php echo e($product->image_url, false); ?>" alt="">
                      </a>
                    </div>
                    <div class="price"><b>￥</b><?php echo e($product->price, false); ?></div>
                    <div class="title">
                      <a href="<?php echo e(route('products.show', ['product' => $product->id]), false); ?>"><?php echo e($product->title, false); ?></a>
                    </div>
                  </div>
                  <div class="bottom">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-shop-1/resources/views/products/index.blade.php ENDPATH**/ ?>