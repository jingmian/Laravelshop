                    ...
                    <table class="table">
                      ...
                      <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <span class="product-title">
                          ...
                          <?php if($index === 0): ?>
                            <td rowspan="<?php echo e(count($order->items), false); ?>" class="text-center total-amount">￥<?php echo e($order->total_amount, false); ?></td>
                            <td rowspan="<?php echo e(count($order->items), false); ?>" class="text-center">
                              ...
                              <?php else: ?>
                                未支付<br>
                                请于 <?php echo e($order->created_at->addSeconds(config('app.order_ttl'))->format('H:i'), false); ?> 前完成支付<br>
                                否则订单将自动关闭
                              <?php endif; ?>
                            </td>
                            <td rowspan="<?php echo e(count($order->items), false); ?>" class="text-center">
                              <a class="btn btn-primary btn-sm" href="<?php echo e(route('orders.show', ['order' => $order->id]), false); ?>">查看订单</a>
                              <!-- 评价入口开始 -->
                              <?php if($order->paid_at): ?>
                                <a class="btn btn-success btn-sm" href="<?php echo e(route('orders.review.show', ['order' => $order->id]), false); ?>">
                                  <?php echo e($order->reviewed ? '查看评价' : '评价', false); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-shop-1/resources/views/orders/index.blade.php ENDPATH**/ ?>